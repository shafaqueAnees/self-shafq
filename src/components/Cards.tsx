        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {cars.map((car, index) => (
              ...
              >
                {/* Car Name */}
                <h3 className="text-xl font-semibold text-gray-800"><button className="bg-blue-600 px-4 py-2 rounded-sm hover:bg-blue-600">
                <a href="/Car-Detail" className="hover:underline">{car.name}</a></button></h3>
